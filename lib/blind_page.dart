    ...
    return Consumer<MyAppState>(
      builder: (context, state, children) => SingleChildScrollView(
          child: Column(
            children: [
              Text('Blind'),
              NumberInputField(label: 'BigBlind', attribute: 'bigBlind', handler: state.updateBigBlind),
              SizedBox(height: 20),
              Row(
              ...
              SizedBox(height: 40),
              NumberInputField(label: 'SmallBlind', attribute: 'smallBlind', handler: state.updateSmallBlind),
              SizedBox(height: 20),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
              ...
              SizedBox(height: 40),
              NumberInputField(label: 'Ante', attribute: 'ante', handler: state.updateAnte),
              SizedBox(height: 20),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
